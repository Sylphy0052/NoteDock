...
function TrashItem({ note, onRestore, onDelete, isRestoring, isDeleting }: TrashItemProps) {
  ...
  return (
    <div className="trash-item">
      <div className="trash-item-info">
        ...
        <span className="trash-item-date">削除日: {formatDate(note.updated_at)}</span>
        {note.tags.length > 0 && (
  ...
  return (
    <div className="trash-page">
      <header className="page-header">
        ...
        <p className="page-description">削除されたノートは30日後に自動的に完全削除されます</p>
      </header>
